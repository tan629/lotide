...
describe("#assertArraysEqual", () => {
  it("returns arrays are identical : [" + ["1", "2", "3"] + "] and [" + ["1", "2", "3"] + "]", () => {
    assert.strictEqual(assertArraysEqual(["1", "2", "3"], ["1", "2", "3"]),true);
  });
  
  it("returns arrays are not identical : [" + ["1", "2", "3", "5"] + "] and [" + ["1", "2", "3","4"] + "]", () => {
    assert.strictEqual(assertArraysEqual(["1", "2", "3","5"], ["1", "2", "3","4"]),false);
  });
  
  it("returns arrays are not identical : [" + ["1", "2"] + "] and [" + ["1", "2", "3","4"] + "]", () => {
